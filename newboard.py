...
def dataScreen():
    ...
    if(hasInternet):
        ...
        size7 = Text(data, font = sizeFont, bd = -2, bg = button_color, fg = main_fg, height=1, width=20)
        size7.insert(INSERT, str(count7) + " 7\" | " + str(weight7) + " lbs")
        size7.place(x=570,y=25)
        size10 = Text(data, font = sizeFont, bd = -2, bg = button_color, fg = main_fg, height=1, width=20)
        size10.insert(INSERT, str(count10) + " 10\" | " + str(weight10) + " lbs")
        size10.place(x=570,y=100)
        size12 = Text(data, font = sizeFont, bd = -2, bg = button_color, fg = main_fg, height=1, width=20)
        size12.insert(INSERT, str(count12) + " 12\" | " + str(weight12) + " lbs")
        size12.place(x=570,y=175)
        size14 = Text(data, font = sizeFont, bd = -2, bg = button_color, fg = main_fg, height=1, width=20)
        size14.insert(INSERT, str(count14) + " 14\" | " + str(weight14) + " lbs")
        size14.place(x=570,y=250)
    else:
