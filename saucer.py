...
def help():
    ...
    # Action buttons
    sos  = Button(top, text = "SOS", font = otherFont, bg = "gray40", fg = "white", command = lambda: sos(top), height = 2, width = 6)
...
# Function button
stopButton  = Button(screen, text = "STOP", font = stopFont, bg = "red", fg = "white", command = stopPumping, height = 2, width = 8)
