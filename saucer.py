...
# Size buttons
fourteenButton  = Button(screen, text = "14\"", font = sizeFont, bg = "green3", fg = "white", command = lambda: setSize(14), height = 2 , width = 3)
fourteenButton.place(x=610, y=25)

twelveButton  = Button(screen, text = "12\"", font = sizeFont, bg = "green3", fg = "white", command = lambda: setSize(12), height = 2 , width = 3)
twelveButton.place(x=415, y=25)

tenButton  = Button(screen, text = "10\"", font = sizeFont, bg = "green3", fg = "white", command = lambda: setSize(10), height = 2 , width = 3)
tenButton.place(x=220, y=25)

sevenButton  = Button(screen, text = "7\"", font = sizeFont, bg = "green3", fg = "white", command = lambda: setSize(7), height = 2 , width = 3)
...
# Function button
stopButton  = Button(screen, text = "STOP", font = stopFont, bg = "firebrick1", fg = "white", command = stopPumping, height = 1, width = 9)
